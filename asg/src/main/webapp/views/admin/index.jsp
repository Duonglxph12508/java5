	...
	<div class="container-fluid">
		<div class="row content">
			<div class="col-sm-2 sidenav hidden-xs">
				<br> <a href="/asg/"><button class="btn btn-warning"
						style="width: 100%;">

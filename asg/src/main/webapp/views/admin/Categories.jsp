	...
	<div class="panel-heading">
		<div class="container">
			<form:form class="form-horizontal" method="POST"
				modelAttribute="cateDTO" action="/asg/admin/cate">
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<button class="btn btn-primary" formaction="/asg/admin/cate/update" >
							<span class="glyphicon glyphicon-floppy-save">Save</span>
						</button>
						<button class="btn btn-success" formaction="/asg/admin/cate/clear">
			...
			<tbody>
				<c:forEach var="item" items="${page}">
					<tr>
						<td>${item.id}</td>
						<td>${item.name}</td>
						<td><a href="/asg/admin/cate/edit/${item.id}"><button
									class="btn btn-warning">
									<span class="glyphicon glyphicon-pencil"></span>
								</button></a></td>
						<td><a href="/asg/admin/cate/delete/${item.id}"><button

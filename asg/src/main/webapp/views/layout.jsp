...
<body>
						...
						<li><a class="dropdown-toggle" data-toggle="dropdown"
							...
							<ul class="nav dropdown-menu">
								<c:if test="${ user.admin == 1 }">
									<li><a href="/asg/admin">Quản Lý Bán Hàng</a></li>
								</c:if>
								<li><a href="/asg/myProfile">Quản Lý Tài Khoản</a></li>
								<li><a href="/asg/login">Đăng Xuất</a></li>
							</ul></li>
					</c:if>

					<li><a href="/asg/cart/view"> <span
	...
	<footer class="text-center">
		<br>
		<p>
			Design By <b>Lê Xuân Dương © ASS_SOF3021</b>
		</p>
	</footer>

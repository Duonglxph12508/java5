...
<div class="container">
	<h2 class="breadcrumb text-center">
		<small> <a href="/asg/cart/view">Shopping Cart</a> <span
		...
		<div class="col-xs-8">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					<form:form role="form" action="/asg/cart/checkout" method="POST" modelAttribute="order">
                        <input path="user" value="${ user}" hidden>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <label for="phone">Số Điện Thoại *</label> <form:input type="text"
                                        class="form-control form-control-small" id="phone" path=""
                                        placeholder="Số điện thoại của bạn" />
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <label for="email">Địa chỉ Email *</label> <form:input path=""
                        ...
                        <div class="form-group">
                            ...
                            <form:textarea class="form-control" rows="5" id="note" path=""

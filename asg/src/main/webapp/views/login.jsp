...
<body class="main-bg">
	<div class="login-container text-c animated flipInX">
		...
		<div class="container-content">
			...
			<form:form class="margin-t" action="${ pageContext.request.contextPath }/login" method="post"
				modelAttribute="acc">
			...
			<a class="text-darkyellow" data-toggle="modal"
				data-target="#modalSignUp" style="cursor: pointer;"><small>Sign
					Up</small></a>

			<p class="margin-t text-whitesmoke">
				<small> Lê Xuân Dương &copy; PH12508</small>
			</p>
		</div>
	</div>
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<input type="password" class="form-control"
											placeholder="Xác nhận  Password *" name="password" required />
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
